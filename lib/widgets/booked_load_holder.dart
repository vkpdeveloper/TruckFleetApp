...
class BookedLoadHolder extends StatefulWidget {
  final String from;
  final String to;
  ...
  @override
  _BookedLoadHolderState createState() => _BookedLoadHolderState();
}

class _BookedLoadHolderState extends State<BookedLoadHolder> {
  @override
